...
class Filemanager {
	...
	public function rename() {
		...
		if(!$this->has_permission('rename') || !$this->is_valid_path($old_file) ) {
			$this->error("No way. $old_file $new_file".(int) $this->is_valid_path($new_file));
		}
	...
	public function delete() {
		...
		if(!$this->has_permission('delete') || !$this->is_valid_path($current_path)) {
			$this->error("No way.".$this->has_permission('delete').' '.$current_path.$this->is_valid_path($current_path));
		}
