...
<head>
    ...
    <title>Home - {{empty($title) ?  'oCoder' : $title}}</title>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="/listen"> Listening Lessons </a>
                    </li>
                    <li class="dropdown">
                        <a href=""> Speaking Lessons </a>
                    </li>
                    <li class="dropdown">
                        <a href=""> Reading Lessons </a>
                    </li>
                    <li class="dropdown">
                        <a href=""> Writing Lessons </a>
                    </li>
                </ul>
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                {{ Auth::user()->username ? Auth::user()->username : 'User'  }} <span class="caret"></span>
                            </a>
