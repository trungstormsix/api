            ...
            <div class="tabs-container">
                ...
                <div class="tabs-left">
                    <ul class="nav nav-tabs">
                        ...
                        <li {!! ($group->id ==1) ? 'class="active"' : '' !!}><a data-toggle="tab" href="#tab-{{$group->id}}" aria-expanded="true">{{$group->title}}</a></li>
                        @endforeach
                    </ul>
                    <div class="tab-content ">
                        @foreach($groups as $group)
                        <div id="tab-{{$group->id}}" class="tab-pane {!! ($group->id ==1) ? 'active' : '' !!}">
