        ...
        <br>
         <form role="search" class="navbar-form-custom" action="{{url('admin/picvoc/search')}}">
                <div class="form-group">
                    <input type="text" placeholder="Search a word laravel..." class="form-control searchvoc" name="search" value="{{!empty($search) ? $search : ""}}"  id="searchVoc">
                </div>
            </form>
        <br>
        ...
        <div class="col-lg-12">
            <div>
                    ...
                    <form style="float: right" class="form-inline" action="http://ocodereducation.com/admin/picvoc/search">
                        <div class="form-group">
                            <input class="form-control searchvoc ui-autocomplete-input" type="text" name="search" value="" placeholder="Search Vocabulary (OLD SITE)..." autocomplete="off">
